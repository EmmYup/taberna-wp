...
<?php if($category_active == null and $tag_active == null){
	query_posts('tag=noticias');
	$activo = True;
	} ?>

<div class="menu-archive">
    <ul>
        <li class="<?php if ($tag_active == 'noticias' or $activo): ?>active<?php endif ?>"><a href="<?php echo esc_url( home_url( '/' ) ); ?>noticias">TODOS</a></li>
        <?php foreach ($categorias as $categoria): ?>
            
            <?php if (strtolower($categoria->name) != 'eventos' ): ?>
                <li class="<?php if($categoria->term_id == $category_active){ echo 'active';} ?>"><a href="<?php echo get_category_link( $categoria->term_id ); ?>"><?php echo $categoria->name; ?></a></li>
            <?php endif ?>
        <?php endforeach ?>
    </ul>
</div>
